...
export const STRINGS: Dict = {
  ...
  "drawer.payment": { en: "Payment", ar: "الدفع" },
  "drawer.paymentRef": { en: "Reference", ar: "المرجع" },
  "payment.succeeded": { en: "Paid", ar: "مدفوع" },
  "payment.pending": { en: "Payment pending", ar: "قيد الدفع" },
  "payment.failed": { en: "Payment failed", ar: "فشل الدفع" },
  "payment.refunded": { en: "Refunded", ar: "مُسترد" },
